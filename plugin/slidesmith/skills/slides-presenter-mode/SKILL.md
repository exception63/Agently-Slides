...
| **每页条数** | **1–3 条** | 实测 5 条（含一条长的）就顶满整屏，还要转表冠 |
...
"s0-agenda":   ["第一部分","第二部分","第三部分","第四部分","AR → 感知触觉落差 → 触觉渴望 → 补偿性消费反应"],       // 5 条且全是结构标签
```
...
第 3 页 [s0-agenda]    ✗ 4 条超限（上限 3）且疑似结构标签
```
...
- [ ] **每一页都有提词** —— 逐页数一遍，别抽查
- [ ] 每页 1–3 条 · 每条 ≤10 汉字 · 没有「第一部分」这类结构标签
